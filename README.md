...
I'm an **Information Management** student passionate about building practical software through **full-stack development**.

I enjoy creating real-world applications while exploring **AI, data analysis, software architecture, and modern web technologies**. I'm always looking for opportunities to learn, collaborate, and grow.

```python
class Aarchi:
    def __init__(self):
        self.currently_building = ["Full-stack Web Applications", "Personal Projects"]
        self.learning = ["React", "Django", "AI Integration", "Software Architecture"]
        self.open_to = ["Open Source", "Internships", "Collaboration"]
        self.ask_me_about = ["Python", "Django", "React", "Git", "SEO", "Data Analysis"]
```
